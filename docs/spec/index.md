...
<SpecToc>
  ...
  <p>
    ...
    <a href="./SPEC-v1.0-rc2">canonical specification</a> — these cards link to the exact sections.
  </p>

  <div class="level-ladder">
    <a class="lvl" href="./SPEC-v1.0-rc2#_6-level-1-—-ai-manifest">
      ...
      <span class="lvl-body">
        ...
        <span class="lvl-file">/.well-known/index-ai.json (or scoped, §5.2)</span>
      </span>
      <span class="lvl-go" aria-hidden="true">→</span>
    </a>
    <a class="lvl" href="./SPEC-v1.0-rc2#_7-level-2-—-agent-view">
    ...
    <a class="lvl" href="./SPEC-v1.0-rc2#_8-level-3-—-query-interface">
  ...
  <div class="spec-cta">
    <a class="btn-spec" href="./SPEC-v1.0-rc2">Open SPEC-v1.0-rc2 <span aria-hidden="true">→</span></a>
