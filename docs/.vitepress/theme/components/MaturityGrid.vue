...
// v4 MaturityGrid (V-005): the validated 5-card maturity matrix (Phase B
// reference pages/changelog.html `.maturity`) rebuilt on the v4 token system.
// One card per artifact with a status badge — RC/Draft/Tested/Proposed/Published.
...
const items: Item[] = [
  ...
  { artifact: 'Benchmark (§13.4)', status: 'Published', evidence: 'protocol + 250-site dataset + results', tone: 'ok' },
]
</script>
